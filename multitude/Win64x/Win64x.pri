...
# Install Qt
qt_bin_files.path = /
qt_bin_files.files = $$[QT_INSTALL_BINS] qt.conf
...
qt_files.path = /qt
qt_files.files = $$[QT_INSTALL_PLUGINS] $$[QT_INSTALL_IMPORTS] $$[QT_INSTALL_TRANSLATIONS] $$[QMAKE_MKSPECS]

INSTALLS += qt_bin_files qt_lib_files qt_include_files qt_files
