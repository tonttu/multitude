...
template<>
FOLLY_API int Futex<std::atomic>::futexWake(int count, uint32_t wakeMask);

template<>
FOLLY_API FutexResult Futex<std::atomic>::futexWaitImpl(
      uint32_t expected,
      std::chrono::time_point<std::chrono::system_clock>* absSystemTime,
      std::chrono::time_point<std::chrono::steady_clock>* absSteadyTime,
      uint32_t waitMask);
...
template<>
FOLLY_API int Futex<EmulatedFutexAtomic>::futexWake(int count, uint32_t wakeMask);

template<>
FOLLY_API FutexResult Futex<EmulatedFutexAtomic>::futexWaitImpl(
      uint32_t expected,
      std::chrono::time_point<std::chrono::system_clock>* absSystemTime,
      std::chrono::time_point<std::chrono::steady_clock>* absSteadyTime,
      uint32_t waitMask);
