...
namespace Valuable
{
  ...
  template <>
  void AttributeIntT<int32_t>::processMessage(const QString &, Radiant::BinaryData & data)
  {
    bool ok = true;
  ...
  template <>
  void AttributeIntT<uint32_t>::processMessage(const QString &, Radiant::BinaryData & data)
  {
    bool ok = true;
  ...
  template <>
  void AttributeIntT<int64_t>::processMessage(const QString &, Radiant::BinaryData & data)
  {
    bool ok = true;
  ...
  template <>
  void AttributeIntT<uint64_t>::processMessage(const QString &, Radiant::BinaryData & data)
  {
    bool ok = true;
  ...
  template <>
  void AttributeIntT<Radiant::TimeStamp>::processMessage(const QString &, Radiant::BinaryData & data)
  {
    bool ok = true;
