...
/**
    ...
    private:
      Valuable::AttributeFloat m_minValue;
      Valuable::AttributeFloat m_maxValue;
      Valuable::AttributeFloat m_currentValue;
    };
    ...
    public:
      ...
      // m_currentValue is a AttributeFloat object, so it also has a cast operator defined for float. We could have also done "return (float)m_currentValue;" here
