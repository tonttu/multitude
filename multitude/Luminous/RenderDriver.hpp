...
namespace Luminous
{
  ...
  public:
    ...
    LUMINOUS_API virtual std::shared_ptr<HardwareBuffer> createVertexBuffer(size_t vertexSize, size_t vertexCount, BufferUsage usage) = 0;
    LUMINOUS_API virtual std::shared_ptr<HardwareBuffer> createConstantBuffer(BufferUsage usage) = 0;
    ...
    LUMINOUS_API virtual void drawArrays(PrimitiveType type, size_t primitives, size_t offset) = 0;
    LUMINOUS_API virtual void drawIndexedArrays(PrimitiveType type, size_t primitives, size_t offset) = 0;
  };
}
