...
namespace Luminous
{
  ...
  public:
    ...
    Valuable::AttributeT<VM1::Maybe> m_autoSelect;
    Valuable::AttributeT<VM1::VideoSource> m_priorityVideoSource;
    Valuable::AttributeT<VM1::SourceStatus> m_statusExternalDVI;
    Valuable::AttributeT<VM1::SourceStatus> m_statusInternalDVI;
    Valuable::AttributeT<VM1::VideoSource> m_activeVideoSource;
    ...
    Valuable::AttributeT<VM1::Maybe> m_colorCorrectionEnabled;
