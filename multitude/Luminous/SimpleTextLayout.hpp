...
namespace Luminous
{
  ...
  public:
    ...
    LUMINOUS_API SimpleTextLayout(SimpleTextLayout && that) noexcept;
    ...
    LUMINOUS_API SimpleTextLayout & operator=(SimpleTextLayout && that) noexcept;
    LUMINOUS_API virtual ~SimpleTextLayout() noexcept;
