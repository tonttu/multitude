...
namespace Luminous
{
    ...
    , m_d(new D(this))
  {
    ...
    if(flags & Qt::X11BypassWindowManagerHint)
      m_d->m_deferredActivateWindow = 10;
  }
  ...
  void QtWindow::poll()
  {
    ...
    // Use this hack get around openbox issues in Ubuntu
    if (m_d->m_deferredActivateWindow > 0) {
      --m_d->m_deferredActivateWindow;
